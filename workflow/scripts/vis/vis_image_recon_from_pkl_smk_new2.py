...
DERIV_DIR = os.path.join(ROOT_DIR, 'derivatives', 'cedalion', 'new_inclQ_test_newnoise_mseamp6_cmeasdiff')
...
folder_name = f"Xs_groupavg_{task}_cov_alpha_spatial_1e-3_alpha_meas_1e4_indirect_Cmeas_noSB_mag_15_25.pkl"
